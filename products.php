            ...
            <?php foreach ($products as $p): ?>
                <div class="col">
                    <div class="card h-100">
                        ...
                        <?php else: ?>
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#e9ecef"></rect><text x="50%" y="50%" fill="#6c757d" dy=".3em" text-anchor="middle">Resim yok</text></svg>
                        <?php endif; ?>
                        <div class="card-body">
