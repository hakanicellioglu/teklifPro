...
$actions .= ' <a href="pdf/render_quotation_pdf.php?id=' . e((string)$offer['id']) . '&csrf_token=' . e($csrfToken) . '" class="btn btn-secondary btn-icon" data-bs-toggle="tooltip" title="Download PDF"><i class="bi bi-file-earmark-pdf"></i></a>';
