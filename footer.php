  ...
  <script src="<?= BASE_URL ?>public/assets/app.js"></script>
  <script src="<?= BASE_URL ?>public/assets/js/product_form.js"></script>
  <script src="<?= BASE_URL ?>public/assets/js/customer.js"></script>
</body>
</html>
